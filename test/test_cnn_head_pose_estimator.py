...
from head_pose.cnn_head_pose_estimator import CnnHeadPoseEstimator
...
my_head_pose_estimator.load_yaw_variables(os.path.join(BASE_DIR, "../models/yaw/cnn_cccdd_30k"))
